...
spark.conf.set("fs.azure.account.auth.type.adfariontest.dfs.core.windows.net", "SAS")
spark.conf.set("fs.azure.sas.token.provider.type.adfariontest.dfs.core.windows.net", "org.apache.hadoop.fs.azurebfs.sas.FixedSASTokenProvider")
spark.conf.set("fs.azure.sas.fixed.token.adfariontest.dfs.core.windows.net", "https://adfariontest.blob.core.windows.net/?sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2025-02-01T21:06:22Z&st=2024-07-29T13:06:22Z&spr=https&sig=JlKrUq12QHKwvwLJcDDD4BWdn2Cb6phNqlTI5pIge8Q%3D")
