...
# MAGIC val (dbrVersion, scalaVersion) = runtimeVersions match {
# MAGIC   case Array(d, _, _, _, s, _*) => (d, s.replace("scala", ""))
# MAGIC   case Array(d, _, _, s, _*)    => (d, s.replace("scala", ""))
# MAGIC   case Array(d, _, s, _*)       => (d, s.replace("scala", ""))
# MAGIC   case Array(d, s, _*)          => (d, s.replace("scala", ""))
# MAGIC   case _ =>
